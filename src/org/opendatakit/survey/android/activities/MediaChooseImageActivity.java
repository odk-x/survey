...
public class MediaChooseImageActivity extends Activity {
	...
	public void onActivityResult(int requestCode, int resultCode, Intent intent) {
		...
		/*
		 * We have chosen a saved image from somewhere, but we really want it to
		 * be in: /sdcard/odk/instances/[current instance]/something.jpg so we
		...
		if (newMedia.exists()) {
			...
			// the
			// content provider.
			String binarypath = MediaUtils.getPathFromUri(mediaURI,
					Images.Media.DATA);
