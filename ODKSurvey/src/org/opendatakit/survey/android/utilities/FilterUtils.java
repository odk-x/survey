...
/**
 * Useful static methods to construct the selection string and selectionArgs array for passing to a
 * content provider. Handles the details of null-valued criteria.
 * 
...
public final class FilterUtils {
     ...
     * representing those constraints as "key is null". Assumes the toString() method will provide
