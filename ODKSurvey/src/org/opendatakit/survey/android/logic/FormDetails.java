...
/**
 * Information about the forms available for download from the OpenRosa Form Discovery API
 * for legacy interaction with ODK Aggregate (assumes all those forms have new-style formDef.json)
 *
