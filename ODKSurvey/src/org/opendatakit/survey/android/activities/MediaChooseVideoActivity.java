...
public class MediaChooseVideoActivity extends Activity {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
		...
		/*
         * We have chosen a saved audio clip from somewhere, but we really want it to be in:
         * /sdcard/odk/instances/[current instance]/something.3gpp so we copy it there
         * and insert that copy into the content provider.
         */

        // get gp of chosen file
        Uri selectedMedia = intent.getData();
        String sourceMediaPath = MainMenuActivity.getPathFromUri(selectedMedia, Video.Media.DATA);
        ...
        if (newMedia.exists()) {
	        ...
	        // content provider.
	        String binarypath = MainMenuActivity.getPathFromUri(mediaURI, Video.Media.DATA);
