 ...
 *
 */
public class InitializationFragment extends AbsBaseFragment implements InitializationListener,
  ...
  private void intializeAppName() {
    ...
    getCommonApplication().initializeAppName(((IAppAwareActivity) getActivity()).getAppName(),
        this);
  }
